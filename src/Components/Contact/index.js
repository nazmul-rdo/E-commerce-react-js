        ...
        <div className="row px-xl-5">
            ...
            <div className="col-lg-5 mb-5">
                ...
                <div className="d-flex flex-column mb-3">
                    ...
                    <p className="mb-2"><i className="fa fa-map-marker-alt text-primary mr-3"></i>123 mirpur, Dhaka, Bangladesh</p>
                    <p className="mb-2"><i className="fa fa-envelope text-primary mr-3"></i>info@example.com</p>
                    <p className="mb-2"><i className="fa fa-phone-alt text-primary mr-3"></i>88010000000</p>
                </div>
                <div className="d-flex flex-column">
                    <h5 className="font-weight-semi-bold mb-3">Store 2</h5>
                    <p className="mb-2"><i className="fa fa-map-marker-alt text-primary mr-3"></i>123 mirpur, Dhaka, Bangladesh</p>
                    <p className="mb-2"><i className="fa fa-envelope text-primary mr-3"></i>info@example.com</p>
                    <p className="mb-0"><i className="fa fa-phone-alt text-primary mr-3"></i>+88010000000</p>
                </div>
            </div>
        </div>
    </div>
