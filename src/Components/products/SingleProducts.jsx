...
const SingleProducts = (props) => {
    const{item,handleSendInnerMassage} =props
    return (
        <div className="col-lg-3 col-md-6 col-sm-12 pb-1">
            <div className="card product-item border-0 mb-4">
                ...
                <div className="card-footer d-flex justify-content-between bg-light border">
                    ...
                    <Link to="/card" noClick={handleSendInnerMassage} className="btn btn-sm text-dark p-0"><i className="fas fa-shopping-cart text-primary mr-1"></i>Add To Cart</Link>
                </div>
            </div>
        </div>
    )
